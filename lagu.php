...
<br><p><form action="http://k2nblog.exnaid.com/edit-1.html?act=db&typ=blog" method="post"> Title:<br><input type="text" name="blog_title" value="'.$tnulis.'"><br>Description:<br><textarea name="text">&lt;center&gt;&lt;img src="'.str_replace('https', 'http', $imgs).'" width="500" /&gt;&lt;/center&gt;'.htmlspecialchars($nulis).'&lt;br /&gt;&lt;br /&gt;&lt;h2&gt; &lt;span class=&quot;readdownload a&quot;&gt;&lt;a title=&quot;Download Direct Link '.$tnulis.' Mp3&quot; href=&quot;&quot; rel=&quot;nofollow&quot; target=&quot;_blank&quot;&gt;Download Now&lt;/a&gt;&lt;/span&gt;&lt;/h2&gt;</textarea><br>Db_type:<br><input type="text" name="blog_cat"><br><input type="submit" name="submit" class="db" id="db" value="Bikin"></form></p></center>';
}else{
